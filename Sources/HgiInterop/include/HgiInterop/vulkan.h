...
// Vulkan support is enabled. Exclude on macOS/iOS and when disabled.
#if !defined(ARCH_OS_DARWIN) && PXR_VULKAN_SUPPORT_ENABLED
...
#endif // !defined(ARCH_OS_DARWIN) && PXR_VULKAN_SUPPORT_ENABLED
